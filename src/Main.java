...
public class Main {
    public static void main(String[] args) throws SQLException, IOException, ClassNotFoundException {
        ...
        Map map = new Map("graph.txt");
        //deSerializeObjects(staticArrayLists);
        try {
            FileInputStream fileIn = new FileInputStream("F:\\CP Projects\\OOP\\OOP project\\src\\StaticArrayLists.txt") ;
        ...
        while (inputValidation) {
            ...
            if (input.equals("END") && !Role.loggedInRoleExistance) {
                ...
                if (inputArray[0].equals("ADD") && (inputArray[1].equals("USER") || inputArray[1].equals("ADMIN") || inputArray[1].equals("DELIVERY")) && inputArray.length == 4 && !Role.loggedInRoleExistance) {
                    ...
                    Functions.commentResponse(commentID, response) ;
                }else if(inputArray[0].equals("DISPLAY") && inputArray[1].equals("OPEN") && inputArray[1].equals("ORDERS") && Role.loggedInRoleExistance && Role.loggedInRole instanceof Admin && Restaurant.loggedInRestaurantForAdmin != null && inputArray.length == 3 && Food.selectedFoodForAdmin == null){
    ...
    public static void serializeObjects(StaticArrayLists staticArrayLists){
        try{
            FileOutputStream fileout = new FileOutputStream("F:\\CP Projects\\OOP\\OOP project\\src\\StaticArrayLists.txt") ;
